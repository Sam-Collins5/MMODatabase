...
namespace MMOngo.Controllers.Testing
{
    public class TestUserLoginController : Controller
    {
        private readonly IUserService _userService;

        public TestUserLoginController(IUserService userService)
        {
        ...
        public IActionResult Login()
        {
            ...
            {
                return RedirectToAction("Status", "TestUserLogin");
            }
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction("Login", "TestUserLogin");
        }

        [HttpPost]
        [Authorize]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> LogoutAndRegister()
        {
            await HttpContext.SignOutAsync(CookieAuthenticationDefaults.AuthenticationScheme);

            return RedirectToAction("Register", "TestUserLogin");
        }
